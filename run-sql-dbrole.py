#!/usr/bin/env python3
"""
Execute script.sql on Azure SQL Database using Azure Active Directory authentication.
Grants the managed identity appropriate database roles.
The script.sql file has MANAGED-IDENTITY-NAME replaced by the deploy script before execution.
"""
import pyodbc
import struct
from azure.identity import AzureCliCredential

# Database connection settings – update after bicep deployment

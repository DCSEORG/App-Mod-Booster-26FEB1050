#!/usr/bin/env python3
"""
Execute stored-procedures.sql on Azure SQL Database using Azure Active Directory authentication.
Creates or updates all stored procedures needed by the Expense Management app.
"""
import pyodbc
import struct
...
def execute_sql_script(server, database, script_file):
    ...
    try:
        ...
        print("\n✓ All stored procedures created/updated successfully!")
